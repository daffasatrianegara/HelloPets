...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/profildok.css">
...
<body>
    ...
    <form class="form" id="form" action="" enctype="multipart/form-data" method="post">
        ...
        <div class="upload">
            ...
            <div class="round">
                <input type="hidden" name="id_user" value="<?php echo $d->id_dokter ?>">
    ...
    if (isset($_FILES["image"]["name"])) {
        ...
        <script>
          ...
          document.location.href = 'profildok.php';
        </script>
        ";
        } else {
            $newImageName = $name . " - " . date("Y.m.d") . " - " . date("h.i.sa"); // Generate new image name
            $newImageName .= '.' . $imageExtension;
            $query = "UPDATE dokter SET foto = '$newImageName' WHERE id_dokter = '" . $d->id_dokter . "'";
    ...
    <div class="header">
        ...
        if (isset($_POST['ubah_data'])) {
            ...
            $update = mysqli_query($con, "UPDATE dokter SET
                                nama = '" . $nama . "',
                                email = '" . $email . "',
                                telepon = '" . $telepon . "'
            ...
            window.location.href='profildok.php';</script>";
            } else {
        ...
        <div class="box">
            ...
            if (isset($_POST['ubah_password'])) {
                ...
                if ($pass2 != $pass1) {
                    ...
                    $u_pass = mysqli_query($con, "UPDATE dokter SET
                                password = '$pass1',
                                passmd5 = '$pass'
                                WHERE id_dokter = '$d->id_dokter' ");
                    if ($u_pass) {
                        echo '<script>alert("Ubah password Berhasil!!")</script>';
                        echo '<script>window.location="profildok.php"</script>';
                    } else {
